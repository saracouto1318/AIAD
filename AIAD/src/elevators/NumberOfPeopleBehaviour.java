...
/**
 * 	Type of behavior for elevators that knows the number of people currently riding the elevator, 
 * but also, nows how many people are waiting for it on each floor.
 * 	This behavior might be better when there are, frequently, floors where the number of people waiting 
